...
import boot.spring.pagemodel.UserValidate;
...
public class UserController {
	...
	public Set<String> getpermissions(){
	 ...
	 @RequestMapping(value="/html/useradmin",method = RequestMethod.GET)
	 public String useradmin(){
		return "html/useradmin";
	 }
	 
	 @RequestMapping(value="/html/roleadmin",method = RequestMethod.GET)
	 public String roleadmin(){
		return "html/roleadmin";
	 }
	 
	 @RequestMapping(value="/html/permissionadmin",method = RequestMethod.GET)
	 public String permissionadmin(){
		return "html/permissionadmin";
	 }
	 ...
	 @ResponseBody
	 public PrincipalCollection info(){
